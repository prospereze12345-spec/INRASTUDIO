...
function VideoSkeleton() {
  return (
    <div className="h-full w-full animate-pulse bg-gradient-to-br from-white/[0.06] to-white/[0.02]" />
  );
}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <MediaCard label="Promo video" icon={Video}>
              ...
              <LazyReveal className="relative h-full w-full" margin="0px">
                {(inView) =>
                  inView ? (
                    <video
                      ...
                      className="h-full w-full object-contain p-3 drop-shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
                    />
                  ) : (
                    <img
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04]">
            <div
              className={`flex items-center gap-2 bg-gradient-to-r ${active.color} px-5 py-3`}
            >
  ...
  return (
    <section className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 pb-20 pt-40 md:pb-32 md:pt-48 lg:flex-row">
      <div className="z-10 w-full flex-1 text-center lg:text-left">
        ...
        >
          Take one photo of your product. We turn it into a flyer with your
          logo on it, a caption for each platform, and a short promo video —
          ready to post in under a minute.
        </motion.p>
    ...
    <section className="flex border-y border-white/5 bg-white/[0.01] py-12">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center px-6">
        <p className="text-center text-sm text-slate-500 text-xl">
          1,102 flyers generated last month by resellers, skincare brands,
          real estate agents, and caterers across Lagos, Abuja, Accra, and
          Nairobi.
        </p>
      </div>
    </section>
      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          <motion.div
            ...
            className="flex w-max gap-5 pb-8"
          >
            {reviews.map((review) => (
              <div
                key={review.name}
...
function Workflow() {
  return (
    <section
      id="dashboards"
      className="border-y border-white/5 bg-[#0a1128] px-6 py-24"
    >
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mb-12 max-w-xl text-slate-400">
          No templates to browse — just a finished draft you can tweak in one
          tap.
        </p>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-black/20">
            ...
            <div className="border-t border-white/10 px-4 py-3 text-sm font-medium text-white">
              Flyer
            </div>
          </div>

          <div className="overflow-hidden rounded-2xl border border-white/10 bg-black/20">
            <LazyReveal className="relative aspect-[4/5]">
              {(inView) =>
                inView ? (
                  <video
          ...
          <div className="flex flex-col justify-center gap-4 rounded-2xl border border-white/10 bg-black/20 p-6">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              "This changed everything for me... 💃🏻👜! I was tired of boring
              handbags until I found this stunning vibrant red patent leather
              top-handle bag. Not only is it a head-turner, but it's also
              incredibly versatile and perfect for any occasion. Whether you're
              heading to a formal event or just running errands, this bag is
              sure to make you feel chic and polished. And the best part? It's
              affordable! 💸 From ₦12,000 — free delivery today only. DM to
              order now — we deliver today. #fashion #handbag #redhot
              #patentleather #tophandle #vibrant #style #elegance
              #sophistication #accessorize."
            </p>
          </div>
        </div>
      </div>
...
function FAQ() {
  const faqs = [
    {
      q: "My photos are usually taken on a normal phone, not a proper camera. Does that matter?",
      a: "Not much. Most sellers upload photos taken on mid-range Android phones, sometimes indoors with regular room lighting. It works — it just won't fix a badly blurred photo.",
    },
    {
      q: "Does this use a lot of data?",
      a: "Uploading a photo is small. Downloading the video is the heaviest part, usually a few MB. You can generate on WiFi and download later if data is tight.",
    },
    {
      q: "Can I edit the caption before I post it?",
      a: "Yes. Treat what we generate as a first draft — most people tweak a line or two before sending.",
    },
    {
      q: "Can I add my own logo?",
      a: "Yes — upload it once and drag it into place on your flyer. Resize it however you like, and it carries over automatically when you switch between Instagram, Story, or TikTok formats.",
    },
    {
      q: "What if I don't like any of the results?",
      a: "Editing text, color, or your logo updates instantly — no regenerating needed. You only need to regenerate if you want to swap the product photo itself.",
    },
    {
      q: "Do you support Naira pricing and local payment?",
      a: "Yes — pricing shows automatically in Naira, Cedis, Kenyan Shilling, or USD based on the country you select when you sign up, and you can pay by card or bank transfer.",
    },
  ];
  ...
  return (
    <section
      id="resources"
      className="mx-auto max-w-3xl border-t border-white/5 px-6 py-24"
    >
      <h2 className="mb-10 text-3xl font-medium tracking-tight text-white md:text-4xl">
      ...
      <div className="relative w-full overflow-hidden rounded-[3rem] border border-white/10 bg-[#0c0c0c] shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center gap-12 p-8 md:flex-row md:gap-16 md:p-24">
          <div className="z-20 flex-1 text-center md:text-left">
            <h2 className="mb-8 font-display text-4xl font-medium leading-[1.1] tracking-tight text-white md:text-6xl lg:text-7xl">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-16 pb-20 lg:flex-row">
        ...
        <div className="flex shrink-0 flex-wrap gap-12 font-mono text-xs uppercase tracking-widest sm:gap-24">
          <div className="flex flex-col gap-4">
            <span className="mb-2 font-bold text-slate-600">
              Legal
            </span>
